...
private val HavenLightColorScheme = lightColorScheme(
    ...
    surface = androidx.compose.ui.graphics.Color(0xFFF9F9F9),
    onSurface = androidx.compose.ui.graphics.Color(0xFF000000),
    surfaceVariant = androidx.compose.ui.graphics.Color(0xFFEFEFEF),
    ...
    outlineVariant = androidx.compose.ui.graphics.Color(0xFFEEEEEE),
)
...
private val HavenDarkColorScheme = androidx.compose.material3.darkColorScheme(
    ...
    primaryContainer = androidx.compose.ui.graphics.Color(0xFFDDDDDD),
    ...
    outlineVariant = androidx.compose.ui.graphics.Color(0xFF222222),
)
